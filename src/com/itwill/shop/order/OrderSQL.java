 ...
 */
	...
	public final static String ORDER_SELECT_WITH_ORDERITEM_PRODUCT_BY_M_ID_O_NO = "select * from orders o join order_item ou on o.o_no = oi.o_no join product p on oi.p_no = p.p_no where m_id = ? and o.o_no =? ";
}
