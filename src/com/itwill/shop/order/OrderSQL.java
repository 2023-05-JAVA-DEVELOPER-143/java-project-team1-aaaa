...
//	public final static String ORDER_SELECT_BY_M_ID = "select * from orders o join userinfo u on o.m_id = u.m_id join order_item oi on o.o_no = oi.o_no where o.user_id = ?";
	...
	public final static String ORDERITEM_DELETE_BY_O_NO = "delete from order_item where o_no=?";
